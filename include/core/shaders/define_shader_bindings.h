...
#else
#define IMAGE_SAMPLER(name, binding, stage) WRAPPER(ImageView*, name, binding, stage, 1, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, nullptr, name##->view->vkImageView, name##_sampler->vkSampler, IMAGE_INFO | INCLUDES_SAMPLER | INCLUDES_IMAGE)
#endif
