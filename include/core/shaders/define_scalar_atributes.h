...
#define VEC2(name, location) glm::vec2 name; 
#define VEC3(name, location) glm::vec3 name; 
#define VEC4(name, location) glm::vec4 name; 
#define INT(name, location) int32_t name; 
#define IVEC2(name, location) glm::ivec2 name;
#define IVEC3(name, location) glm::ivec3 name; 
#define IVEC4(name, location) glm::ivec4 name;
#define UINT(name, location) uint32_t name; 
#define UVEC2(name, location) glm::uvec2 name;
#define UVEC3(name, location) glm::uvec3 name; 
#define UVEC4(name, location) glm::uvec4 name; 
